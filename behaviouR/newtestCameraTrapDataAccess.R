...
CameraTrapDataAccess <-
  function(urlpath = 'https://storage.googleapis.com/public-datasets-lila/snapshotserengeti-unzipped/',
           season = list(1, 2),
           AnimalID = 'leopard',
           NumPhotos = 5,
           create.dir = '') {
...
CombinedAnimalDF <- CameraTrapDataAccess(urlpath = "https://storage.googleapis.com/public-datasets-lila/snapshotserengeti-unzipped/", 
